...
def inherits_from(obj, a_class):
    ...
    or indirectly) from the specified class. Excludes instances of the specified
    class itself.
    ...
    Returns:
        True if obj is an instance of a subclass of a_class (but not a_class itself), False otherwise.
